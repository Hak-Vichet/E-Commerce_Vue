...
<template>
  <div class="mt-10 grid md:grid-cols-2 p-10">
    <div class="p-5">
      <img :src="selectedImage.src" alt="Product" class="cursor-pointer object-cover rounded-[10px]" />
    ...
    >
      <div class="relative">
        ...
        <button class="absolute top-2 right-2 text-white text-xl cursor-pointer">&times;</button>


        <img alt="Product" class="w-96 h-96 object-cover" />
      </div>
    </div> -->
